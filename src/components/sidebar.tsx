...
const navItems = [
  ...
  { href: '/dashboard/inbox', icon: MessageSquareText, label: 'WhatsApp Inbox' },
  { href: '/dashboard/leads', icon: Users, label: 'CRM & Funil' },
  { href: '/dashboard/agenda', icon: Calendar, label: 'Agenda' },
  { href: '/dashboard/pacientes', icon: UserSquare2, label: 'Pacientes' },
  { href: '/dashboard/profissionais', icon: User, label: 'Profissionais' },
]
  ...
  return (
    <div className="flex h-screen w-64 flex-col border-r bg-slate-50">
      ...
      <div className="border-t p-4">
        <button className="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-slate-500 transition-all hover:bg-red-50 hover:text-red-600 text-left">
